...
public class AESEncryptUtils {
     ...
     * 加解密密钥, 外部可以
     */
    public static final String AES_DATA_SECURITY_KEY = "/";
    /**
     * 算法/加密模式/填充方式
     */
    ...
    public static void main(String[] args) {
        ...
        String encrypt = encrypt("421127111111111111");
        System.out.println(encrypt);
        String decrypt = decrypt("hgO1OCQsSnVGUBsg+boNos9lJ6ZYKy6Ep3wRdikg6G0=");
        System.out.println(decrypt);
        String s = encryptPersonKey("123123");
